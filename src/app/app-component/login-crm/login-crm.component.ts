...
export class LoginCrmComponent implements OnInit {
  @ViewChild("loginform", { read: ElementRef, static: true })
  loginformelmnt: ElementRef;
  ...
  ngOnInit() {
    ...
    this.returnUrl =
      this.route.snapshot.queryParams["returnUrl"] || "dashboards";
    this.loginForm.valueChanges.subscribe(() => {
      this.error = "";
      this.loginformelmnt.nativeElement.classList.remove("wrong-entry");
    });
  }
  ...
  onLoginSubmit() {
    ...
    this.authenticationService
      ...
      .subscribe(
        ...
        error => {
          this.loginformelmnt.nativeElement.classList.add("wrong-entry");
